...
checkNoInst vue-clerk || return 1
npm i vue-clerk
...
insertMainfile $importSnippet $injectSnippet

cp $HOME/UserScripts/vite/Clerk &
Firebase/LoginBtn.vue src/components
...
mkdir src/services
cp $HOME/UserScripts/vite/Clerk &
Firebase/firebase.ts src/services/firebase.ts
