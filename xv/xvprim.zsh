...
"
  ...
  mainImp=$(gsedWrapPreproc $mainImp)
  gsed -i "/createApp(Popup)/,\$! {/^$/d}
0,/createApp(Popup)/{// s|^|$mainImp\n\n\n|}" src/popup.ts

  mainAppUse=$(gsedWrapPreproc $mainAppUse)
  gsed -i "/createApp(Popup)/,/app.mount/ {/^$/d}
0,/app.mount/{// s|^|$mainAppUse\n\n\n|}" src/popup.ts
